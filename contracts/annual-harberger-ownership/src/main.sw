...
abi IAnnualHarberger {
    ...
    #[storage(read, write)] fn assess_value(nomen: b256, assessed_value: u64);
    #[storage(read, write)] fn stabilize(nomen: b256);
    #[storage(read)] fn in_harberger(nomen: b256) -> bool;
    #[storage(read)] fn next_harberger(nomen: b256) -> u64;
    #[storage(read)] fn next_stabilization(nomen: b256) -> u64;
